package com.lkyl.oceanframework.log.spelExt.parser;
...
import com.lkyl.oceanframework.log.spelExt.token.Token;
import com.lkyl.oceanframework.log.spelExt.token.TokenKind;
import com.lkyl.oceanframework.log.spelExt.token.Tokenizer;
...
public class LogRecordValueParser extends TemplateAwareExpressionParser {
     ...
     */
    public LogRecordValueParser(SpelParserConfiguration configuration) {
