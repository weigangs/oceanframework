...
public class PageQueryDtoFileGenerator implements FileGenerator{
    ...
    private final static String CLASS_NAME_SUFFIX = "PageQueryDTO";
    @Override
    public TempldateFileTypeEnum getFileType() {
        return TempldateFileTypeEnum.PAGE_QUERY_DTO;
    }
