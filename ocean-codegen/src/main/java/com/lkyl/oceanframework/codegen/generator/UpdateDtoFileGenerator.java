...
public class UpdateDtoFileGenerator implements FileGenerator{
    ...
    private final static String CLASS_NAME_SUFFIX = "UpdateDTO";
    @Override
    public TempldateFileTypeEnum getFileType() {
        return TempldateFileTypeEnum.UPDATE_DTO;
    }
